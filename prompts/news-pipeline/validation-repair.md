...
computed.eventAtSource=FIRST_REPORT의 시각은 최초 보도 시각이며 사건 발생 시각 주장이 아니다. 공통 조건부 영향의 4개 세대 동일 문장, 기사에 확인된 역할을 설명하는 관점, 미래 사건 검색어는 정상 정책이다. 검증 의견이 이를 부정하더라도 이 정책을 따른다.
