...
export namespace create {
  ...
  export const path = () => "/pipeline/runs";
}
 ...
 * @path POST /pipeline/runs/:runId/retry
...
export namespace retry {
  ...
  export const METADATA = {
    method: "POST",
    path: "/pipeline/runs/:runId/retry",
    request: {
      type: "application/json",
      encrypted: false,
    },
 ...
 * @path POST /pipeline/runs/:runId/interrupt
...
export namespace interrupt {
  ...
  export const METADATA = {
    method: "POST",
    path: "/pipeline/runs/:runId/interrupt",
    request: {
      type: "application/json",
      encrypted: false,
    },
